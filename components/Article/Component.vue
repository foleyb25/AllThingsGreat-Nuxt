<template>
    <div class="flex flex-col">
        <div class="h-[45%] w-full">
            <img class="h-full w-full object-fill" :src="article.imageUrl" alt="">
        </div>
        <div class="m-3 h-[55%]">
            ...
            <div class="flex items-center font-light h-[10%] p-1">
                ...
                <a href="#" class="text-sm font-medium text-gray-900 underline hover:no-underline dark:text-white">{{ article.numComments }} comments</a>
            </div>
            <div class="font-light text-slate-300 p-1">
                {{article.writer.password}}
            </div>
        </div>
